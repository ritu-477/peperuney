        ...
        <div className='sm:bg-peperuney-meme bg-cover lg:bg-[length:100%_100%] bg-center bg-no-repeat relative max-sm:bg-mobile-meme max-sm:bg-[length:100%_100%]'>
            ...
            <div className='lg:pt-[207px] sm:pt-5 flex lg:gap-[70px] xl:gap-[100px] gap-12 sm:pb-[151px] 2xl:mx-auto 3xl:max-w-[1920px] w-full 3xl:justify-between'>
                ...
                <div data-aos="zoom-in" className='relative max-w-[820px] overflow-x-hidden'>
                    ...
                    >
                        <SwiperSlide>
                            <img className='w-full h-[250px] md:h-[267px] lg:h-[259px] xl:h-[360px] object-cover' src={bullsImg} alt="bulls-image" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img className='w-full h-[250px] md:h-[267px] lg:h-[259px] xl:h-[360px] object-cover' src={posterCarusel} alt="poster-carusel" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img className='w-full h-[250px] md:h-[267px] lg:h-[259px] xl:h-[360px] object-cover' src={posterCaruselTwo} alt="poster-carusel-two" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img className='w-full h-[250px] md:h-[267px] lg:h-[259px] xl:h-[360px] object-cover' src={bullsImg} alt="bulls-image" />
                        </SwiperSlide>
                    ...
                    <div className='max-sm:mx-auto max-sm:text-center sm:mt-11 max-sm:mb-[73px] max-sm:mt-[133px]'><button className='sm:max-w-[293px] transition duration-300 transform hover:scale-105'><Icon className='sm:block hidden' iconName='createMeme' /><Icon className='sm:hidden block' iconName='memeCreate'></Icon></button>
                    </div>
                </div>
            </div>
        </div>
