...
const MeetPeperuney = () => {
  return (
      <div className='relative meet-bg'>
          <img className='absolute sm:block hidden -top-1 w-full max-xl:h-[200px] xl:h-[272px]' src={meetLayer} alt="meet-layer" />
          <img src={meetSmaalLayer} className='absolute top-0 h-[200px] sm:hidden block w-full' alt="small-layer" />
          <img className='absolute top-8' src={CloudsImg} alt="clouds-image" />
              ...
              <div className='w-full relative'>
                  ...
                  <div className='lg:flex-row flex-col max-lg:flex-col-reverse flex gap-1 relative z-10'>
                      ...
                      <div className='lg:w-[56%] w-full'>
                          ...
                          <div className='sm:bg-meet-vector max-sm:bg-meet-small bg-[length:100%_100%] bg-no-repeat bg-center sm:px-8 sm:py-10 px-3'>
