            ...
            <div className='container max-w-[1360px] lg:pb-[293px] lg:pt-[250px] pt-[200px]'>
                <div className='w-full relative'>
                    ...
                    <div className='lg:flex-row flex-col max-lg:flex-col-reverse flex gap-1 relative z-10'>
                        <div data-aos="fade-right" className='lg:w-[44%] flex items-center justify-center relative z-10'>
                            ...
                            <div className='sm:bg-meet-vector max-sm:bg-meet-small bg-[length:100%_100%] bg-no-repeat bg-center sm:px-7 sm:py-10 px-3'>
                                ...
                                <div className='sm:ps-12 ps-4'>
                                    ...
                                    <div className='flex justify-between max-sm:gap-2 sm:pt-5 items-center sm:pb-4 pb-3'>
                                        <p className='xl:text-custom-3xl xl:leading-custom-5xl sm:text-2xl text-custom-xl text-charcoal-black font-schoolbell'>FEELS GREAT MAN!</p>
                                        <button><Icon className='xl:max-w-[337px] lg:max-w-[240px] md:max-w-[200px] max-w-[127px] transition duration-300 transform hover:scale-105' iconName='manifesto' /></button>
                                    </div>
                                </div>
                            </div>
                        </div>
