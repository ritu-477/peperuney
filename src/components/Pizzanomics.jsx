        ...
        <div className='relative bg-crimson-red overflow-hidden max-w-[1440px] mx-auto'>
            ...
            <div data-aos="zoom-out-up" className='flex lg:flex-row flex-col-reverse justify-between gap-5'>
                <div className='relative z-10 lg:-mt-10 xl:-mt-20 lg:ml-[60px] xl:ml-[67px]'>
                    <img className='max-w-[301px] sm:max-w-[420px] xl:max-w-[485px] w-full mx-auto lg:mx-0 max-md:pb-4' src={peperunryImg} alt="peperunry-image" />
                </div>
            ...
            <div className='sm:bg-pizzanomics-bg bg-cover lg:bg-[length:100%_100%] bg-no-repeat bg-center max-sm:bg-mobile-view'>
                <div className="sm:bg-tax-layer max-sm:bg-mobile-layer bg-100 -mt-[207px] bg-cover bg-no-repeat bg-center min-h-[1190px] pt-[162px]">
                    <div className="flex w-full flex-col lg:flex-row gap-7 sm:gap-12 xl:ml-auto px-5 xl:px-0 xl:mx-11 mx-auto xl:w-fit md:-mb-[200px]">
                        <div data-aos="slide-right" className="max-w-[503px] w-full pt-7 mx-auto lg:mx-0 flex flex-col items-center relative z-10">
                            ...
                            <button className='mt-5 sm:block hidden'><Icon className='transition duration-300 transform hover:scale-105' iconName='earn' /></button>
                            <button className='mt-7 sm:hidden block'><Icon className='transition duration-300 transform hover:scale-105' iconName='earnNow' /></button>
                        </div>
                        <img data-aos="slide-left" src={pizza} alt="pizza" className='lg:max-w-[656px] max-w-[468px] mx-auto sm:w-full -ml-14 sm:mx-auto lg:mx-0 max-sm:-mt-8' />
                    </div>
                    <div data-aos="fade-up" className='max-sm:bg-pi zzanomics-card bg-cover bg-no-repeat bg-center relative bg-card-pizzanomics md:pt-[160px] lg:pt-[320px]  max-sm:mt-[184px]'>
