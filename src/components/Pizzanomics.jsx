    ...
    return (
        <div className='relative bg-crimson-red overflow-hidden'>
            ...
            <div data-aos="zoom-out-up" className='flex lg:flex-row flex-col-reverse justify-between gap-5'>
                ...
                <div className="lg:max-w-[812px] lg:w-full -mx-5 lg:mx-0">
                    <div className='bg-black relative -rotate-3 w-full h-[341px] pb-10 sm:pb-11 flex justify-center items-end -mt-[240px] sm:-mt-[225px] lg:-mt-[243px]'>
                        <p className='font-luckiest font-normal text-[70px] sm:text-[80px] md:text-[110px] xl:text-[135px] leading-[100%] text-white uppercase mb-0.5'>42 BILLION</p>
                    </div>
                ...
                <div className="flex flex-col lg:flex-row justify-between mt-2 relative">
                    ...
                    <div className="max-w-[942px] lg:w-full relative z-10 -mt-12 lg:mt-0 -mx-10 lg:mx-0">
                    ...
                    <span className='lg:flex bg-crimson-red w-full absolute left-0 hidden -top-1 xl:top-10 z-[1] h-24'></span>
            </div>
