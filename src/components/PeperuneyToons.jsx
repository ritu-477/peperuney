    ...
    return (
        <div className='flex flex-col'>
            ...
            <div className='md:bg-room-layer bg-room-mobile bg-no-repeat bg-100 bg-cover bg-center xl:bg-left min-h-[700px] md:min-h-[900px] pt-8 relative overflow-hidden max-sm:-mt-[1px]'>
                ...
                <img src={peperuney} alt="peperuney" className='ml-auto absolute max-w-[347px] md:max-w-[668px] w-full right-0 z-20 pointer-events-none -bottom-5 md:bottom-0' />
                <div className="container relative">
                    <div className=" z-10 absolute xl:left-[374px] lg:left-[216px] left-6 sm:left-10 md:left-[88px] max-w-[265px] sm:max-w-[450px] md:max-w-[477px] w-full top-[195px] sm:top-[160px] md:top-[89px]">
                        <div data-aos="fade-up" className="relative">
                            ...
                            <img src="" alt="video" className={`${play ? "z-20" : ""} absolute left-0 top-0 w-full`} />
                            <div onClick={ClickPlay} className="bg-white grid place-items-center cursor-pointer h-16 w-16 rounded-full absolute left-1/2 top-1/2 z-20 -translate-x-1/2 -translate-y-1/2 border-2 border-black duration-300 ease-linear hover:opacity-70"><Icon iconName='play' /></div>
                        </div>
                    </div>
                </div>
            </div>
