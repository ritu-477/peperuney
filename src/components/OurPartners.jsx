...
const OurPartners = () => {
    ...
    return (
        <div className='bg-our-partners bg-cover bg-no-repeat bg-center lg:pt-[113px] pt-16 pb-[46px] xl:pb-[280px] lg:pb-56' id="meme">
            <div className='container'>
                <div data-aos="fade-up" className='flex flex-col justify-center items-center max-w-[1200px] w-full mx-auto'>
                    ...
                    <img src={weWorkImg} alt="work" className='lg:w-[444px] w-[250px] lg:pb-[100px] sm:pb-12 pb-4 sm:-mt-5 -mt-3' />
