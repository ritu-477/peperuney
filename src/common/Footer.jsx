...
const Footer = () => {
  ...
  return (
      <div className='relative'>
          ...
          <div data-aos="zoom-in" className='container max-sm:px-2'>
              <div className='z-10 relative flex xl:justify-between justify-center items-center flex-wrap max-xl:gap-6 py-5 md:pt-3 md:pb-9'>
                  ...
                  <div className='flex max-sm:gap-3 gap-4'>
                      ...
                      <div className='bg-black size-8 p-2 cursor-pointer'><Icon iconName='solarCopy' /></div>
                      <div className='border border-black size-8 p-2 cursor-pointer'><Icon iconName='formKit' /></div>
                  </div>
